...
[![CI](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-vpc-endpoint-aws)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-aws/releases)

---

## Purpose

Terraform atom module for a single AWS VPC Endpoint resource. Supports both Interface and Gateway endpoint types for private connectivity to AWS services without traversing the public internet.
...
|------|-------------|------|---------|:--------:|
| <a name="input_service_name"></a> [service\_name](#input\_service\_name) | The service name for the VPC endpoint (e.g., com.amazonaws.us-east-1.s3). | `string` | n/a | yes |
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | ID of the VPC in which to create the endpoint. | `string` | n/a | yes |
| <a name="input_attributes"></a> [attributes](#input\_attributes) | ID element. Additional attributes (e.g. `workers` or `cluster`) to add to `id`,<br/>in the order they appear in the list. New attributes are appended to the<br/>end of the list. The elements of the list are joined by the `delimiter`<br/>and treated as a single ID element. | `list(string)` | `[]` | no |
| <a name="input_auto_accept"></a> [auto\_accept](#input\_auto\_accept) | Whether to automatically accept the VPC endpoint connection. | `bool` | `null` | no |
...
| <a name="input_policy"></a> [policy](#input\_policy) | IAM policy document for the VPC endpoint. JSON string. | `string` | `null` | no |
...
| <a name="input_vpc_endpoint_type"></a> [vpc\_endpoint\_type](#input\_vpc\_endpoint\_type) | Type of VPC endpoint. Valid values: Interface, Gateway, GatewayLoadBalancer. | `string` | `"Interface"` | no |
...
| <a name="output_prefix_list_id"></a> [prefix\_list\_id](#output\_prefix\_list\_id) | Prefix list ID for Gateway endpoints. |
